...
import { getDiscounts, updateDiscount, deleteDiscount } from '../../../api'
...
export const ManageDiscounts = () => {
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            setDiscounts((prevState) => prevState.filter((discount) => discount.discountId !== discountToDelete));
    ...
    const handleSaveEdit = async (updatedDiscount) => {
        ...
        try {
            ...
            setDiscounts((prevState) => prevState.map((discount) => discount.discountId === updatedDiscount.discountId ? updatedDiscount : discount));
